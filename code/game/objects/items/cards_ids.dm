...
/obj/item/card/id/examine(mob/user)
	...
	if(HAS_TRAIT(user, TRAIT_ID_APPRAISER))
		. += HAS_TRAIT(src, TRAIT_JOB_FIRST_ID_CARD) ? span_boldnotice("Hmm... yes, this ID was issued by Overwatch!") : span_boldnotice("This ID was created in this district, not by Overwatch.")
...
/obj/item/card/id/advanced/gold/captains_spare
	name = "district administrator's spare ID"
