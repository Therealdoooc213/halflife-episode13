...
/obj/machinery/computer/communications/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/ui_state)
	...
	switch (action)
		...
		if("requestSafeCodes")
			...
			minor_announce("Due to staff shortages, your station has been approved for delivery of access codes to secure the district administrator's Spare ID. Delivery via drop pod at [get_area(pod_location)]. ETA 120 seconds.")
