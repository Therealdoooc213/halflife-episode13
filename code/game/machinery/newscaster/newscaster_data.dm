...
/datum/feed_network/New()
	create_feed_channel("District Announcements", "SS13", "Company news, staff announcements, and all the latest information. Have a secure shift!", locked = TRUE, hardset_channel = 1000)
