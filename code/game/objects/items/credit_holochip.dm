/obj/item/holochip
	...
	desc = "An advanced holographic projector which simulates credit vouchers. Acts the same as physical currency, but is easier for the combine to produce and keep track of."
